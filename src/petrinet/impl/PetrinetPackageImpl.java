...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getPetrinet_Nodes(), this.getNode(), this.getNode_Petrinet(), "nodes", null, 0, -1, Petrinet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArc_Petrinet(), this.getPetrinet(), this.getPetrinet_Arcs(), "petrinet", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNode_Petrinet(), this.getPetrinet(), this.getPetrinet_Nodes(), "petrinet", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
